...
class UserCreateDTO(BaseModel):
    ...
    UserCreateDTO
    """ # noqa: E501
    username: Optional[Annotated[str, Field(min_length=6, strict=True, max_length=25)]] = None
    ...
    first_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, alias="firstName")
    last_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, alias="lastName")
    email: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=320)]] = None
    phone: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=25)]] = None
    language: Optional[StrictStr] = None
    time_zone: Optional[StrictStr] = Field(default=None, alias="timeZone")
    live_update_enabled: Optional[StrictBool] = Field(default=None, alias="liveUpdateEnabled")
    __properties: ClassVar[List[str]] = ["username", "roleName", "accessType", "accountName", "customerName", "firstName", "lastName", "email", "phone", "language", "timeZone", "liveUpdateEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "liveUpdateEnabled": obj.get("liveUpdateEnabled")
        })
        return _obj
