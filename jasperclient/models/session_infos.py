...
class SessionInfos(BaseModel):
    ...
    date_session_started: Optional[datetime] = Field(
        default=None, alias="dateSessionStarted"
    )
    date_session_ended: Optional[datetime] = Field(
        default=None, alias="dateSessionEnded"
    )
