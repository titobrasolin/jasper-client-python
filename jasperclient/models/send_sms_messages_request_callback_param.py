...
class SendSmsMessagesRequestCallbackParam(BaseModel):
    """
    SendSmsMessagesRequestCallbackParam
    """  # noqa: E501

    callback_type: Optional[StrictStr] = Field(default=None, alias="callbackType")
    callback_url: Optional[StrictStr] = Field(default=None, alias="callbackUrl")
    __properties: ClassVar[List[str]] = ["callbackType", "callbackUrl"]
