...
class ActivateTerminalEventRequest(BaseModel):
    ...
    unlimited_instances: Optional[StrictBool] = Field(
        default=False, alias="unlimitedInstances"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "instances": (
                    obj.get("instances") if obj.get("instances") is not None else 1
                ),
                "unlimitedInstances": (
                    obj.get("unlimitedInstances")
                    if obj.get("unlimitedInstances") is not None
                    else False
                ),
            }
        )
