...
class CustomerDTO(BaseModel):
    ...
    security_question: Optional[
        Annotated[str, Field(min_length=10, strict=True, max_length=100)]
    ] = Field(default=None, alias="securityQuestion")
    security_answer: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=100)]
    ] = Field(default=None, alias="securityAnswer")
    ship_to_bill_address: Optional[StrictBool] = Field(
        default=False, alias="shipToBillAddress"
    )
    contacts: Optional[List[Dict[str, Any]]] = None
    billing_address: Optional[CustomerDTOBillingAddress] = Field(
        default=None, alias="billingAddress"
    )
    shipping_address: Optional[CustomerDTOBillingAddress] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "shipToBillAddress": (
                    obj.get("shipToBillAddress")
                    if obj.get("shipToBillAddress") is not None
                    else False
                ),
                "contacts": obj.get("contacts"),
                "billingAddress": (
                    CustomerDTOBillingAddress.from_dict(obj["billingAddress"])
                    if obj.get("billingAddress") is not None
                    else None
                ),
                "shippingAddress": (
                    CustomerDTOBillingAddress.from_dict(obj["shippingAddress"])
