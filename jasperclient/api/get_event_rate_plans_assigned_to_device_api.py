...
class GetEventRatePlansAssignedToDeviceApi:
    ...
    def get_terminal_events(
        ...
        _param = self._get_terminal_events_serialize(
    ...
    @validate_call
    def get_terminal_events_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        iccid: Annotated[StrictStr, Field(description="ICCID of the device")],
        page_size: Annotated[Optional[StrictInt], Field(description="Maximum of 50, defaults to 50")] = None,
    ...
    @validate_call
    def get_terminal_events_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        iccid: Annotated[StrictStr, Field(description="ICCID of the device")],
        page_size: Annotated[Optional[StrictInt], Field(description="Maximum of 50, defaults to 50")] = None,
    ...
    def _get_terminal_events_serialize(
        self,
        api_version,
        iccid,
        page_size,
