...
class EchoApi:
    ...
    def get_msg(
        ...
        _param = self._get_msg_serialize(
            param=param,
    ...
    @validate_call
    def get_msg_without_preload_content(
        self,
        param: StrictStr,
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    def _get_msg_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v{apiVersion}/echo/{param}",
