...
class EditDeviceApi:
    ...
    def edit_device(
        ...
        device_edit_model: Annotated[DeviceEditModel, Field(description="At least one parameter is required")],
        ...
        :param device_edit_model: At least one parameter is required (required)
        :type device_edit_model: DeviceEditModel
        ...
        _param = self._edit_device_serialize(
            iccid=iccid,
            api_version=api_version,
            device_edit_model=device_edit_model,
    ...
    @validate_call
    def edit_device_with_http_info(
        self,
        iccid: Annotated[StrictStr, Field(description="ICCID")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        device_edit_model: Annotated[DeviceEditModel, Field(description="At least one parameter is required")],
    ...
    @validate_call
    def edit_device_without_preload_content(
        self,
        iccid: Annotated[StrictStr, Field(description="ICCID")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        device_edit_model: Annotated[DeviceEditModel, Field(description="At least one parameter is required")],
    ...
    def _edit_device_serialize(
        ...
        if device_edit_model is not None:
            _body_params = device_edit_model
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v{apiVersion}/devices/{iccid}',
