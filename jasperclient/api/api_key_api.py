...
class APIKeyApi:
    ...
    def get_api_key_for_an_user(
        ...
        _param = self._get_api_key_for_an_user_serialize(
            user_id=user_id,
    ...
    @validate_call
    def get_api_key_for_an_user_with_http_info(
        self,
        user_id: Annotated[StrictStr, Field(description="userId")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_api_key_for_an_user_without_preload_content(
        self,
        user_id: Annotated[StrictStr, Field(description="userId")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    def _get_api_key_for_an_user_serialize(
        self,
        user_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/v{apiVersion}/apikey/{userId}",
