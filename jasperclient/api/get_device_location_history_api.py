...
class GetDeviceLocationHistoryApi:
    ...
    def get_device_location_history(
        ...
        from_date: Annotated[Optional[StrictStr], Field(description="If this is not specified, most recent 2 location records will be returned. </br> The format is yyyy-MM-ddTHH:mm:ssZ </br> Eg: 2018-07-18T17:31:34+00:00")] = None,
        to_date: Annotated[Optional[StrictStr], Field(description="If this is not specified, location history up until the current date will be returned. </br> The format is yyyy-MM-ddTHH:mm:ssZ </br> Eg: 2018-07-18T17:31:34+00:00")] = None,
