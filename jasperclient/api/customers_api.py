...
class CustomersApi:
    ...
    def create_customer(
        ...
        customer_dto: Annotated[CustomerDTO, Field(description="Customer Details")],
        ...
        :param customer_dto: Customer Details (required)
        :type customer_dto: CustomerDTO
    ...
    def _create_customer_serialize(
        ...
        if customer_dto is not None:
            _body_params = customer_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v{apiVersion}/customers',
    ...
    def get_customer_details(
        ...
        _param = self._get_customer_details_serialize(
    ...
    @validate_call
    def get_customer_details_with_http_info(
        self,
        customer_id: Annotated[StrictStr, Field(description="Customer Id")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_customer_details_without_preload_content(
        self,
        customer_id: Annotated[StrictStr, Field(description="Customer Id")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    def _get_customer_details_serialize(
        self,
        customer_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v{apiVersion}/customers/{customerId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
