...
class GetDeviceDetailsApi:
    ...
    def get_device_by_iccid(
        ...
        _param = self._get_device_by_iccid_serialize(
            iccid=iccid,
    ...
    @validate_call
    def get_device_by_iccid_with_http_info(
        self,
        iccid: Annotated[StrictStr, Field(description="ICCID")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_device_by_iccid_without_preload_content(
        self,
        iccid: Annotated[StrictStr, Field(description="ICCID")],
        api_version: Annotated[StrictStr, Field(description="Defaults to 1")],
        _request_timeout: Union[
    ...
    def _get_device_by_iccid_serialize(
        self,
        iccid,
        api_version,
        _request_auth,
