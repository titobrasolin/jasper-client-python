...
from jasperclient.configuration import Configuration
from jasperclient.api_response import ApiResponse, T as ApiResponseT
import jasperclient.models
from jasperclient import rest
from jasperclient.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(jasperclient.models, klass)
